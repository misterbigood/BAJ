...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
                    ...
                    <h1 class="">Accueil</h1>
                    <section class="section-1 grid-9 has-gutter-xl"> <!-- Première section, fond blanc, deux colonnes -->
                        <div class="col-5"><!-- Première colonne - Affichage de la page Accueil ; page modifiable dans l'admin de wordpress -->
                            <?php
                        ...
                        <div class="col-4 txtcenter"> <!-- Deuxième colonne - Partie fixe -->
                    ...
                    <section class="section-2 grid-9 has-gutter-xl"> <!-- Deuxième section, fond bleu pâle, deux colonnes -->
                        <div class="col-5"> <!-- Première colonne - Affichage des cinq derniers RDV à l'agenda -->
                        ...
                        <div class="col-4"> <!-- Deuxième colonne - Affichage de la page Les conférences; page modifiable dans l'admin de wordpress -->
                            <?php
